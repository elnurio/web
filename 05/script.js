...
const pointsPerRing = 400;

const ringSpacing = 3;

const baseRadius = 10;

const radiusVariation = 2000; // <<<=== УВЕЛИЧЕНО (было 30)
...
const basePulseAmplitude = 10; // <<<=== УВЕЛИЧЕНО (было 40)
...
const waveAmplitudeX = 1; 
const waveAmplitudeY = 000; 
const waveFrequencyZ = 0.5; 
...
const organVolumes = [0.1, 0.1, 0.15, 0.1]; 
const positionFreqShiftRange = 100; 
const filterStartFreq = 6000; 
const filterEndFreq = 500; 
const filterQ = 5; 
